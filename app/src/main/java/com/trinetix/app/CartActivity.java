...
public class CartActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
	    ...
	    logKey = getResources().getString(R.string.trinetix);
	...
	private void loadCartItems()
	{
		new AsyncTask<Void, Void, List<Product>>()
		{
			...
			{
				Log.e(logKey, "Started onPostExecute() in CartActivity");
				cartListView = (ListView) findViewById(R.id.cart_listview);
				adapter = new CartAdapter(CartActivity.this, R.layout.cart_list_item, productList);
				cartListView.setAdapter(adapter);
				Log.e(logKey, "Finished onPostExecute() in CartActivity");
			}
		}.execute();
	}
}
